...
* Линейная регрессия всех выходах Тритона (https://github.com/TreetonOrg/DistanceCoef/blob/master/results/regressor_1.csv) даёт коэффициент коррелляции Спирмена лучше текущего, но иногда выбрасывает сильно за пределы от 0 до 1, и MSE ужасный.
